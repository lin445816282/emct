...
def api_get_config():
    ...
    return {
        ...
        "trailing_stop_pct": c.get("trailing_stop_pct", 3),
        "risk_per_trade_pct": c.get("risk_per_trade_pct", 2),
...
def api_update_config(data: dict):
    ...
    return {"ok": True, "weights": saved.get("weights",{}), "thresholds": saved.get("thresholds",{}),
            ...
            "trailing_stop_pct": saved.get("trailing_stop_pct", 3),
            "risk_per_trade_pct": saved.get("risk_per_trade_pct", 2), "max_hold_days": saved.get("max_hold_days"),
